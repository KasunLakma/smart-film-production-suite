...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-20 h-14 px-6 bg-studio-900/80 backdrop-blur border-b border-studio-700 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[11px] font-semibold tracking-wider uppercase">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-studio-700">
          <div className="w-8 h-8 rounded-full bg-studio-accent text-white font-bold text-xs flex items-center justify-center shadow-inner">
            KL
          </div>
        </div>
      </div>
